...
class TestDataPreparation(unittest.TestCase):
    ...
    def test_resolve_path_with_env(self):
        ...
        old_data_root = os.environ.get("NIDS_DATA_ROOT")
        old_proj_root = os.environ.get("NIDS_PROJECT_ROOT")
        try:
            ...
            if "NIDS_DATA_ROOT" in os.environ:
                del os.environ["NIDS_DATA_ROOT"]
            if "NIDS_PROJECT_ROOT" in os.environ:
            ...
            if old_data_root is not None:
                os.environ["NIDS_DATA_ROOT"] = old_data_root
            elif "NIDS_DATA_ROOT" in os.environ:
                del os.environ["NIDS_DATA_ROOT"]

            if old_proj_root is not None:
                os.environ["NIDS_PROJECT_ROOT"] = old_proj_root
            elif "NIDS_PROJECT_ROOT" in os.environ:
                del os.environ["NIDS_PROJECT_ROOT"]
